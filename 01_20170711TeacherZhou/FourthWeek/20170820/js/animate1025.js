~function () {
     ...
     * @param options
     */
    //animate(box,{left:600},animationEffect.Back.easeInOut);//->问题: 当一个函数需要传递很多实参的时候,并且有些实参可以不传递,如果我们还是定义成一个个形参的方式,处理起来非常的麻烦,受到传递顺序的限制了
    //->解决方案: 我们定义一个实参options:{}把我们需要传递的实参当作一个对象属性名和属性值传递进来,这样不会受到顺序的限制
    // animate({
    //     curEle: box,
    //     target: {
    //         left: 600
    ...
    function animate(options) {
        ...
        //->_default.curEle/_default.duration这样使用太长了,写起来麻烦,我们把需要使用的属性值用一些简单的变量存储起来
