...
//     //->鼠标事件对象中常用的一些属性
//     //1.clientX / clientY
//     //当前鼠标触发点距离当前窗口(不是body: 第一屏左上角)左上角的X/Y坐标
//
//     //2.pageX / pageY
...
//->在IE678中并不像标准浏览器一样,执行方法的时候传递一个事件对象,IE678下什么都没传递,事件对象无法通过形参获取
document.body.onclick = function (e) {
    console.log(arguments.length);//->IE678: 0
    //=>window.event: IE678中,把我们需要的事件对象存储在全局的event属性中,获取的时候到这个属性中去读取
