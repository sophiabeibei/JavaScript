...
var Zepto = function () {
  function F(a) {
    ...
    var b = !!a && "length" in a && a.length,
        d = c.type(a);return "function" != d && !H(a) && ("array" == d || 0 === b || "number" == typeof b && b > 0 && b - 1 in a);
  }function M(a) {
    ...
    var b, c;return j[a] || (b = i.createElement(a), i.body.appendChild(b), c = getComputedStyle(b, "").getPropertyValue("display"), b.parentNode.removeChild(b), "none" == c && (c = "block"), j[a] = c), j[a];
  }function S(a) {
    ...
    for (b in d) {
      e && (K(d[b]) || E(d[b])) ? (K(d[b]) && !K(c[b]) && (c[b] = {}), E(d[b]) && !E(c[b]) && (c[b] = []), U(c[b], d[b], e)) : d[b] !== a && (c[b] = d[b]);
    }
  }function V(a, b) {
    ...
    b(a);for (var c = 0, d = a.childNodes.length; d > c; c++) {
      ...
      s = ["after", "prepend", "before", "append"],
      t = i.createElement("table"),
      u = i.createElement("tr"),
      v = { tr: i.createElement("tbody"), tbody: t, thead: t, tfoot: t, td: u, th: u, "*": i.createElement("div") },
      w = /^[\w-]*$/,
      x = {},
      y = x.toString,
      z = {},
    ...
    var c, d, e, f;return b && a && 1 === a.nodeType ? (c = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.matchesSelector) ? c.call(a, b) : (e = a.parentNode, f = !e, f && (e = C).appendChild(a), d = ~z.qsa(e, b).indexOf(a), f && C.removeChild(a), d) : !1;
  }, A = function A(a) {
    ...
    var f, g, j;return n.test(b) && (f = c(i.createElement(RegExp.$1))), f || (b.replace && (b = b.replace(o, "<$1></$2>")), d === a && (d = m.test(b) && RegExp.$1), d in v || (d = "*"), j = v[d], j.innerHTML = "" + b, f = c.each(h.call(j.childNodes), function () {
      j.removeChild(this);
    ...
    var e;if (!b) return z.Z();if ("string" == typeof b) {
      if (b = b.trim(), "<" == b[0] && m.test(b)) e = z.fragment(b, RegExp.$1, d), b = null;else {
        if (d !== a) return c(d).find(b);e = z.qsa(i, b);
      }
    } else {
      if (G(b)) return c(i).ready(b);if (z.isZ(b)) return b;if (E(b)) e = M(b);else if (J(b)) e = [b], b = null;else if (m.test(b)) e = z.fragment(b.trim(), RegExp.$1, d), b = null;else {
        if (d !== a) return c(d).find(b);e = z.qsa(i, b);
      }
    }return z.Z(e, b);
  }, c = function c(a, b) {
    ...
    var b,
        c = h.call(arguments, 1);return "boolean" == typeof a && (b = a, a = c.shift()), c.forEach(function (c) {
      U(a, c, b);
    }), a;
  }, z.qsa = function (a, b) {
    var c,
        ...
        e = !d && "." == b[0],
        f = d || e ? b.slice(1) : b,
        g = w.test(f);return a.getElementById && g && d ? (c = a.getElementById(f)) ? [c] : [] : 1 !== a.nodeType && 9 !== a.nodeType && 11 !== a.nodeType ? [] : h.call(g && !d && a.getElementsByClassName ? e ? a.getElementsByClassName(f) : a.getElementsByTagName(b) : a.querySelectorAll(b));
    ...
    var b = Number(a),
        c = typeof a === "undefined" ? "undefined" : _typeof(a);return null != a && "boolean" != c && ("string" != c || a.length) && !isNaN(b) && isFinite(b) || !1;
    ...
    x["[object " + b + "]"] = b.toLowerCase();
  }), c.fn = { constructor: z.Z, length: 0, forEach: e.forEach, reduce: e.reduce, push: e.push, sort: e.sort, splice: e.splice, indexOf: e.indexOf, concat: function concat() {
      var a,
          b,
          c = [];for (a = 0; a < arguments.length; a++) {
        b = arguments[a], c[a] = z.isZ(b) ? b.toArray() : b;
      ...
      if ("complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll) setTimeout(function () {
        ...
        var b = function b() {
          i.removeEventListener("DOMContentLoaded", b, !1), window.removeEventListener("load", b, !1), a(c);
      ...
      }) : (e = "string" == typeof b ? this.filter(b) : L(b) && G(b.item) ? h.call(b) : c(b), this.forEach(function (a) {
      ...
      var b,
          d = this;return b = a ? "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? c(a).filter(function () {
      ...
      var d = [],
          e = "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && c(a);return this.each(function (c, f) {
        for (; f && !(e ? e.indexOf(f) >= 0 : z.matches(f, a));) {
          f = f !== b && !I(f) && f.parentNode;
        }f && d.indexOf(f) < 0 && d.push(f);
      }), c(d);
    }, parents: function parents(a) {
      for (var b = [], d = this; d.length > 0;) {
      ...
      if (this[0]) {
        c(this[0]).before(a = c(a));for (var b; (b = a.children()).length;) {
          a = b.first();
        }c(a).append(this);
      }return this;
      ...
      return 0 in arguments ? this.each(function (b) {
        var d = this.innerHTML;c(this).empty().append(W(this, a, b, d));
      }) : 0 in this ? this[0].innerHTML : null;
    }, text: function text(a) {
      return 0 in arguments ? this.each(function (b) {
        var c = W(this, a, b, this.textContent);this.textContent = null == c ? "" : "" + c;
      }) : 0 in this ? this.pluck("textContent").join("") : null;
    }, attr: function attr(c, d) {
      var e;return "string" != typeof c || 1 in arguments ? this.each(function (a) {
        if (1 === this.nodeType) if (J(c)) for (b in c) {
          X(this, b, c[b]);
        } else X(this, c, W(this, d, a, this.getAttribute(c)));
      ...
      var d = "data-" + b.replace(q, "-$1").toLowerCase(),
          e = 1 in arguments ? this.attr(d, c) : this.attr(d);return null !== e ? Z(e) : a;
    }, val: function val(a) {
      ...
      });if (!this.length) return null;if (i.documentElement !== this[0] && !c.contains(i.documentElement, this[0])) return { top: 0, left: 0 };var b = this[0].getBoundingClientRect();return { left: b.left + window.pageXOffset, top: b.top + window.pageYOffset, width: Math.round(b.width), height: Math.round(b.height) };
    }, css: function css(a, d) {
      var e, f, g, h;if (arguments.length < 2) {
        if (e = this[0], "string" == typeof a) {
          if (!e) return;return e.style[A(a)] || getComputedStyle(e, "").getPropertyValue(a);
        }if (E(a)) {
          if (!e) return;return f = {}, g = getComputedStyle(e, ""), c.each(a, function (a, b) {
        ...
        a[b] || 0 === a[b] ? h += O(b) + ":" + Q(b, a[b]) + ";" : this.each(function () {
      ...
      return a ? this.each(function (b) {
        if ("className" in this) {
          d = [];var e = Y(this),
              f = W(this, a, b, e);f.split(/\s+/g).forEach(function (a) {
      ...
      return this.each(function (c) {
        if ("className" in this) {
          if (b === a) return Y(this, "");d = Y(this), W(this, b, c, d).split(/\s+/g).forEach(function (a) {
            d = d.replace(P(a), " ");
          }), Y(this, d.trim());
        }
      });
      ...
      return b ? this.each(function (e) {
        var f = c(this),
            g = W(this, b, e, Y(this));g.split(/\s+/g).forEach(function (b) {
          (d === a ? !f.hasClass(b) : d) ? f.addClass(b) : f.removeClass(b);
        });
      }) : this;
    }, scrollTop: function scrollTop(b) {
      if (this.length) {
    ...
    }, scrollLeft: function scrollLeft(b) {
      if (this.length) {
      ...
      if (this.length) {
        var a = this[0],
            b = this.offsetParent(),
            d = this.offset(),
            e = p.test(b[0].nodeName) ? { top: 0, left: 0 } : b.offset();return d.top -= parseFloat(c(a).css("margin-top")) || 0, d.left -= parseFloat(c(a).css("margin-left")) || 0, e.top += parseFloat(c(b[0]).css("border-top-width")) || 0, e.left += parseFloat(c(b[0]).css("border-left-width")) || 0, { top: d.top - e.top, left: d.left - e.left };
      }
    }, offsetParent: function offsetParent() {
      return this.map(function () {
        for (var a = this.offsetParent || i.body; a && !p.test(a.nodeName) && "static" == c(a).css("position");) {
          a = a.offsetParent;
        }return a;
      });
    ...
    var e = d % 2;c.fn[b] = function () {
      var b,
          g,
          f = c.map(arguments, function (d) {
        var e = [];return b = F(d), "array" == b ? (d.forEach(function (b) {
          return b.nodeType !== a ? e.push(b) : c.zepto.isZ(b) ? e = e.concat(b.get()) : (e = e.concat(z.fragment(b)), void 0);
        }), e) : "object" == b || null == d ? d : z.fragment(d);
      }),
          h = this.length > 1;return f.length < 1 ? this : this.each(function (a, b) {
        g = e ? b : b.parentNode, b = 0 == d ? b.nextSibling : 1 == d ? b.firstChild : 2 == d ? b : null;var j = c.contains(i.documentElement, g);f.forEach(function (a) {
          if (h) a = a.cloneNode(!0);else if (!g) return c(a).remove();g.insertBefore(a, b), j && $(a, function (a) {
            if (!(null == a.nodeName || "SCRIPT" !== a.nodeName.toUpperCase() || a.type && "text/javascript" !== a.type || a.src)) {
              var b = a.ownerDocument ? a.ownerDocument.defaultView : window;b["eval"].call(b, a.innerHTML);
            }
          });
        });
      });
  ...
  }), z.Z.prototype = T.prototype = c.fn, z.uniq = B, z.deserializeValue = Z, c.zepto = z, c;
...
!function (a) {
  function e(b) {
    ...
    var c, d, e, h;return a = a.replace(/=#\]/g, '="#"]'), e = g.exec(a), e && e[2] in f && (c = f[e[2]], d = e[3], a = e[1], d && (h = Number(d), d = isNaN(h) ? d.replace(/^["']|["']$/g, "") : h)), b(a, c, d);
  }var b = a.zepto,
      c = b.qsa,
      d = b.matches,
      f = a.expr[":"] = { visible: function visible() {
...
!function (a) {
  function l(a) {
    ...
    var m = l(b),
      ...
      var g, l;return "ready" == d ? a(document).ready(e) : (g = n(d), g.fn = e, g.sel = h, g.e in k && (e = function e(b) {
    ...
    if (d || !b.isDefaultPrevented) {
      ...
      } catch (e) {}(d.defaultPrevented !== c ? d.defaultPrevented : "returnValue" in d ? d.returnValue === !1 : d.getPreventDefault && d.getPreventDefault()) && (b.isDefaultPrevented = t);
    }return b;
  }function y(a) {
    var b,
        d = { originalEvent: a };for (b in a) {
    ...
    var h,
        g = 2 in arguments && d.call(arguments, 2);if (e(b)) return h = function h() {
    ...
    return !1;
  }, v = /^([A-Z]|returnValue$|layer[XY]$|webkitMovement[XY]$)/, w = { preventDefault: "isDefaultPrevented", stopImmediatePropagation: "isImmediatePropagationStopped", stopPropagation: "isPropagationStopped" }, a.fn.delegate = function (a, b, c) {
    ...
    var k,
      ...
      m.on(a, g, h, b, j);
    }), m) : (f(g) || e(i) || i === !1 || (i = h, h = g, g = c), (i === c || h === !1) && (i = h, h = c), i === !1 && (i = u), m.each(function (c, e) {
      j && (k = function k(a) {
    ...
    var c, d, e;if (f(a) || (b = a, a = b.type), c = document.createEvent(h[a] || "Events"), d = !0, b) for (e in b) {
...
!function (a) {
  function m(b, c, d) {
    ...
    var c = b.context;return b.beforeSend.call(c, a, b) === !1 || n(b, c, "ajaxBeforeSend", [a, b]) === !1 ? !1 : (n(b, c, "ajaxSend", [a, b]), void 0);
  }function r(a, b, c, d) {
    var e = c.context,
        f = "success";c.success.call(e, a, f, b), d && d.resolveWith(e, [a, f, b]), n(c, e, "ajaxSuccess", [b, c, a]), t(f, b, c);
  }function s(a, b, c, d, e) {
    var f = d.context;d.error.call(f, c, b, a), e && e.rejectWith(f, [c, b, a]), n(d, f, "ajaxError", [c, d, a || b]), t(b, c, d);
  }function t(a, b, c) {
    var d = c.context;c.complete.call(d, b, a), n(c, d, "ajaxComplete", [b, c]), p(c);
  }function u(a, b, c) {
    if (c.dataFilter == v) return a;var d = c.context;return c.dataFilter.call(d, a, b);
  }function v() {}function w(a) {
    return a && (a = a.split(";", 2)[0]), a && (a == j ? "html" : a == i ? "json" : g.test(a) ? "script" : h.test(a) && "xml") || "text";
  }function x(a, b) {
    return "" == b ? a : (a + "&" + b).replace(/[&?]{1,2}/, "?");
  }function y(b) {
    b.processData && b.data && "string" != a.type(b.data) && (b.data = a.param(b.data, b.traditional)), !b.data || b.type && "GET" != b.type.toUpperCase() && "jsonp" != b.dataType || (b.url = x(b.url, b.data), b.data = void 0);
  }function z(b, c, d, e) {
    ...
    var f,
      ...
      f = a.type(i), e && (c = d ? e : e + "[" + (h || "object" == f || "array" == f ? c : "") + "]"), !e && g ? b.add(i.name, i.value) : "array" == f || !d && "object" == f ? B(b, i, d, c) : b.add(c, i);
    });
  }var d,
      e,
      A,
      ...
      j = "text/html",
      k = /^\s*$/,
      l = c.createElement("a");l.href = window.location.href, a.active = 0, a.ajaxJSONP = function (d, e) {
    if (!("type" in d)) return a.ajax(d);var j,
        m,
        f = d.jsonpCallback,
        g = (a.isFunction(f) ? f() : f) || "Zepto" + b++,
      ...
      clearTimeout(m), a(h).off().remove(), "error" != b.type && j ? r(j[0], l, d, e) : s(null, c || "error", l, d, e), window[g] = i, j && a.isFunction(i) && i(j[0]), i = j = void 0;
    }), q(l, d) === !1 ? (k("abort"), l) : (window[g] = function () {
      j = arguments;
    }, h.src = d.url.replace(/\?(.+)=\?/, "?$1=" + g), c.head.appendChild(h), d.timeout > 0 && (m = setTimeout(function () {
      k("timeout");
    }, d.timeout)), l);
  }, a.ajaxSettings = { type: "GET", beforeSend: v, success: v, error: v, complete: v, context: null, global: !0, xhr: function xhr() {
      return new window.XMLHttpRequest();
    }, accepts: { script: "text/javascript, application/javascript, application/x-javascript", json: i, xml: "application/xml, text/xml", html: j, text: "text/plain" }, crossDomain: !1, timeout: 0, processData: !0, cache: !0, dataFilter: v }, a.ajax = function (b) {
    var h,
        i,
        j,
        m,
        ...
        D,
        f = a.extend({}, b || {}),
        g = a.Deferred && a.Deferred();for (d in a.ajaxSettings) {
      void 0 === f[d] && (f[d] = a.ajaxSettings[d]);
    }if (o(f), f.crossDomain || (h = c.createElement("a"), h.href = f.url, h.href = h.href, f.crossDomain = l.protocol + "//" + l.host != h.protocol + "//" + h.host), f.url || (f.url = window.location.toString()), (i = f.url.indexOf("#")) > -1 && (f.url = f.url.slice(0, i)), y(f), j = f.dataType, m = /\?.+=\?/.test(f.url), m && (j = "jsonp"), f.cache !== !1 && (b && b.cache === !0 || "script" != j && "jsonp" != j) || (f.url = x(f.url, "_=" + Date.now())), "jsonp" == j) return m || (f.url = x(f.url, f.jsonp ? f.jsonp + "=?" : f.jsonp === !1 ? "" : "callback=?")), a.ajaxJSONP(f, g);if (n = f.accepts[j], p = {}, t = function t(a, b) {
      p[a.toLowerCase()] = [a, b];
    }, z = /^([\w-]+:)\/\//.test(f.url) ? RegExp.$1 : window.location.protocol, A = f.xhr(), B = A.setRequestHeader, g && g.promise(A), f.crossDomain || t("X-Requested-With", "XMLHttpRequest"), t("Accept", n || "*/*"), (n = f.mimeType || n) && (n.indexOf(",") > -1 && (n = n.split(",", 2)[0]), A.overrideMimeType && A.overrideMimeType(n)), (f.contentType || f.contentType !== !1 && f.data && "GET" != f.type.toUpperCase()) && t("Content-Type", f.contentType || "application/x-www-form-urlencoded"), f.headers) for (e in f.headers) {
      t(e, f.headers[e]);
    }if (A.setRequestHeader = t, A.onreadystatechange = function () {
      if (4 == A.readyState) {
        A.onreadystatechange = v, clearTimeout(C);var b,
            c = !1;if (A.status >= 200 && A.status < 300 || 304 == A.status || 0 == A.status && "file:" == z) {
          if (j = j || w(f.mimeType || A.getResponseHeader("content-type")), "arraybuffer" == A.responseType || "blob" == A.responseType) b = A.response;else {
            b = A.responseText;try {
    ...
    }, q(A, f) === !1) return A.abort(), s(null, "abort", A, f, g), A;if (D = "async" in f ? f.async : !0, A.open(f.type, f.url, D, f.username, f.password), f.xhrFields) for (e in f.xhrFields) {
      A[e] = f.xhrFields[e];
    }for (e in p) {
      B.apply(A, p[e]);
    ...
    var b = z.apply(null, arguments);return b.type = "POST", a.ajax(b);
  }, a.getJSON = function () {
    var b = z.apply(null, arguments);return b.dataType = "json", a.ajax(b);
    ...
    var d = [];return d.add = function (b, c) {
...
!function (a) {
  var c,
      b = [];a.fn.remove = function () {
    return this.each(function () {
      this.parentNode && ("IMG" === this.tagName && (b.push(this), this.src = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=", c && clearTimeout(c), c = setTimeout(function () {
        b = [];
...
!function (a) {
  function g(f, g) {
    ...
    var d = c[e],
        f = d && b[d];return f ? !a.isEmptyObject(f) : !1;
...
!function (a) {
  function c(b) {
    var d = [["resolve", "done", a.Callbacks({ once: 1, memory: 1 }), "resolved"], ["reject", "fail", a.Callbacks({ once: 1, memory: 1 }), "rejected"], ["notify", "progress", a.Callbacks({ memory: 1 })]],
        e = "pending",
        ...
        var b = arguments;return c(function (c) {
          a.each(d, function (d, e) {
            var h = a.isFunction(b[d]) && b[d];g[e[1]](function () {
              var d,
                  g,
                  b = h && h.apply(this, arguments);b && a.isFunction(b.promise) ? b.promise().done(c.resolve).fail(c.reject).progress(c.notify) : (d = this === f ? c.promise() : this, g = h ? [b] : arguments, c[e[0] + "With"](d, g));
            });
          }), b = null;
        }).promise();
      }, promise: function promise(b) {
        return null != b ? a.extend(b, f) : f;
      } },
        g = {};return a.each(d, function (a, b) {
      var c = b[2],
          h = b[3];f[b[1]] = c.add, h && c.add(function () {
        e = h;
  ...
  }var b = Array.prototype.slice;a.when = function (d) {
    var j,
        k,
        l,
        e = b.call(arguments),
        f = e.length,
        g = 0,
        h = 1 !== f || d && a.isFunction(d.promise) ? f : 0,
        i = 1 === h ? d : c(),
        m = function m(a, c, d) {
      return function (e) {
        c[a] = this, d[a] = arguments.length > 1 ? b.call(arguments) : e, d === j ? i.notifyWith(c, d) : --h || i.resolveWith(c, d);
      };
    };if (f > 1) for (j = new Array(f), k = new Array(f), l = new Array(f); f > g; ++g) {
      e[g] && a.isFunction(e[g].promise) ? e[g].promise().done(m(g, l, e)).fail(i.reject).progress(m(g, k, j)) : --h;
...
!function (a, b) {
  function r(a) {
    ...
    var t,
        ...
        A = !1;if (d === b && (d = a.fx.speeds._default / 1e3), s === b && (s = 0), a.fx.off && (d = 0), "string" == typeof c) u[m] = c, u[n] = d + "s", u[p] = s + "s", u[o] = e || "linear", z = a.fx.animationEnd;else {
      v = [];for (t in c) {
        g.test(t) ? w += t + "(" + c[t] + ") " : (u[t] = c[t], v.push(r(t)));
      }w && (u[h] = w, v.push(h)), d > 0 && "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && (u[i] = v.join(", "), u[j] = d + "s", u[l] = s + "s", u[k] = e || "linear");
    }return _y = function y(b) {
      if ("undefined" != typeof b) {
        if (b.target !== b.currentTarget) return;a(b.target).unbind(z, _y);
      } else a(this).unbind(z, _y);A = !0, a(this).css(q), f && f.call(this);
    }, d > 0 && (this.bind(z, _y), setTimeout(function () {
      A || _y.call(x);
...
!function (a, b) {
  function h(c, d, e, f, g) {
    "function" != typeof d || g || (g = d, d = b);var h = { opacity: e };return f && (h.scale = f, c.css(a.fx.cssPrefix + "transform-origin", "0 0")), c.animate(h, d, null, g);
  }function i(b, c, d, e) {
    return h(b, c, 0, d, function () {
      f.call(a(this)), e && e.call(this);
    });
  }var c = window.document,
      e = (c.documentElement, a.fn.show),
      f = a.fn.hide,
      g = a.fn.toggle;a.fn.show = function (a, c) {
    ...
    return c === b || "boolean" == typeof c ? g.call(this, c) : this.each(function () {
      var b = a(this);b["none" == b.css("display") ? "show" : "hide"](c, d);
    });
  }, a.fn.fadeTo = function (a, b, c) {
    return h(this, a, b, null, c);
  }, a.fn.fadeIn = function (a, b) {
    var c = this.css("opacity");return c > 0 ? this.css("opacity", 0) : c = 1, e.call(this).fadeTo(a, c, b);
  }, a.fn.fadeOut = function (a, b) {
    return i(this, a, null, b);
  }, a.fn.fadeToggle = function (b, c) {
    return this.each(function () {
      var d = a(this);d[0 == d.css("opacity") || "none" == d.css("display") ? "fadeIn" : "fadeOut"](b, c);
    });
  };
}(Zepto);
...
!function (a) {
  function d(a) {
    ...
    var c,
        b = {};a(document).bind("gesturestart", function (a) {
      var e = Date.now();e - (b.last || e), b.target = d(a.target), c && clearTimeout(c), b.e1 = a.scale, b.last = e;
    }).bind("gesturechange", function (a) {
      b.e2 = a.scale;
    }).bind("gestureend", function () {
      b.e2 > 0 ? (0 != Math.abs(b.e1 - b.e2) && a(b.target).trigger("pinch") && a(b.target).trigger("pinch" + (b.e1 - b.e2 > 0 ? "In" : "Out")), b.e1 = b.e2 = b.last = 0) : "last" in b && (b = {});
...
!function () {
  try {
    ...
    var b = getComputedStyle;window.getComputedStyle = function (a, c) {
      try {
        return b(a, c);
      } catch (d) {
        return null;
...
!function (a) {
  String.prototype.trim === a && (String.prototype.trim = function () {
    ...
    if (void 0 === this || null === this) throw new TypeError();var f,
        c = Object(this),
        d = c.length >>> 0,
        e = 0;if ("function" != typeof b) throw new TypeError();if (0 == d && 1 == arguments.length) throw new TypeError();if (arguments.length >= 2) f = arguments[1];else for (;;) {
      if (e in c) {
        f = c[e++];break;
...
!function (a) {
  a.fn.end = function () {
    ...
    var c = a.fn[b];a.fn[b] = function () {
      var a = c.apply(this, arguments);return a.prevObject = this, a;
    };
  });
}(Zepto);
  ...
  function i(a, b, c, d) {
    ...
    var o,
      ...
      (!(t = n(f, "up")) || m(f)) && (k(), b.x2 && Math.abs(b.x1 - b.x2) > 30 || b.y2 && Math.abs(b.y1 - b.y2) > 30 ? e = setTimeout(function () {
        b.el && (b.el.trigger("swipe"), b.el.trigger("swipe" + i(b.x1, b.x2, b.y1, b.y2))), b = {};
      }, 0) : "last" in b && (30 > q && 30 > r ? d = setTimeout(function () {
        var d = a.Event("tap");d.cancelTouch = l, b.el && b.el.trigger(d), b.isDoubleTap ? (b.el && b.el.trigger("doubleTap"), b = {}) : c = setTimeout(function () {
